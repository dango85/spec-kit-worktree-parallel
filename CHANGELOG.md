...
### Added
- `speckit.worktree.create` command — spawn isolated worktrees with configurable layout
- `speckit.worktree.list` command — dashboard of all active worktrees with spec-artifact and task progress
- `speckit.worktree.clean` command — safe cleanup of merged, orphaned, or stale worktrees
