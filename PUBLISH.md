...
gh repo create abiyadav/spec-kit-worktree-parallel --public --source . --push
# or manually:
git remote add origin https://github.com/abiyadav/spec-kit-worktree-parallel.git
...
```markdown
| [Worktree Parallel](https://github.com/abiyadav/spec-kit-worktree-parallel) | Default-on worktree isolation for parallel agents — sibling or nested layout | abiyadav |
```
